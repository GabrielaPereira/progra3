...
public class Principal {
	...
	private void initialize() {
		...
		textField.setBounds(10, 104, 86, 20);
		...
		textField_2.setBounds(271, 104, 86, 20);
		...
		btn_op.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				a = j.genOperador();
				b = j.genOperador();
				lbl_op2.setText(j.mostrarOperador(a));
				lbl_op1.setText(j.mostrarOperador(b));
			}
		});
		...
		btn_verificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				j.agregarOp(a);
				j.agregarOp(b);
				j.agregarNum(Integer.parseInt(textField.getText()));
				j.agregarNum(Integer.parseInt(textField_1.getText()));
				j.agregarNum(Integer.parseInt(textField_2.getText()));
				j.verificarCuenta();
			}
		});
